...
def initialize(wires:int=4, shots:int=5000, trash_qubits:int=0, device_name:str='default.qubit'):
...
class QuantumAutoencoder:
    def __init__(self, wires:int=4, shots:int=5000, trash_qubits:int=0, device_name:str='default.qubit',backend_name:str='autograd'):
        self.circuit = None
        self.device_name = device_name
        initialize(wires=wires, shots=shots, trash_qubits=trash_qubits, device_name=device_name)
...
class QuantumTrainer():
    def __init__(self,model,lr=0.001,optimizer=None,loss_fn=None,save=True,**kwargs):
        ...
        self.train_max_n=kwargs['train_max_n'] or int(1e5)
        self.valid_max_n=kwargs['valid_max_n'] or int(2e4)
        self.epochs=kwargs['epochs'] or 20
        self.patience=kwargs['patience'] or 4
        self.saving=save
